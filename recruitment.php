...
if(isset($_POST['submit'])){
    ...
    $query="INSERT INTO work (w_name, w_age, w_gender, work, w_incharge) VALUES ('$name', '$age', '$gender', '$work', '$incharge') ";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="contact-form">
                        <div id="success"></div>
                        <form action="recruitment.php" method="post" name="sentMessage" id="contactForm" novalidate="novalidate" > 
                            ...
                            <div class="control-group">
                                <input type="number" class="form-control" id="age" placeholder="age" name="age" min="1 " max="120" required="required" data-validation-required-message="Please enter your age" />
                                <p class="help-block text-danger"></p>
                            </div>
      ...
      <input type="radio" name="gender" id="female" value="female"> Female<br>
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="work" name="work" placeholder="Types of work" required="required" data-validation-required-message="Please enter your email" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control" id=" incharge" name="incharge" placeholder="Incharge Name" required="required" data-validation-required-message="Please enter your password" />
                                <p class="help-block text-danger"></p>
                            </div>
