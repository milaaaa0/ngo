...
if(isset($_POST['submit'])){
    ...
    $query="INSERT INTO edu (e_name, e_age, e_instructor, e_camp) VALUES ('$name', '$age', '$instructor', '$camp') ";
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="contact-form">
                        <div id="success"></div>
                        <form action="edu.php" method="post" name="sentMessage" id="contactForm" novalidate="novalidate" > 
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="work" name="instructor" placeholder="Instructor Name" required="required" data-validation-required-message="Please enter Instructor Name" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="numner" class="form-control" id=" camp" name="camp" placeholder="Camp no" required="required" data-validation-required-message="Please enter Camp no" />
                                <p class="help-block text-danger"></p>
                            </div>
