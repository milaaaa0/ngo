...
if(isset($_POST['submit'])){
    ...
    $sql= "SELECT * FROM personal_info where person_email='$mail' and person_pass='$pass'";
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="contact-form">
                        <div id="success"></div>
                        <form action="login.php " method="post" name="sentMessage" id="contactForm" novalidate="novalidate">
                    ...
                    <input class="form-control" type="password" name="pass">
                            ...
                            <div>
                                <button class="btn btn-custom" type="submit" name="submit" id="login">Login</button>
                            </div>
                            <p class="text-center pt-5 pb-3">If you're new user, sign up here! </p>
            <p class="text-center"><button class="btn btn-white" ><a href="personal.php"> SIGN UP</button></p><a>
